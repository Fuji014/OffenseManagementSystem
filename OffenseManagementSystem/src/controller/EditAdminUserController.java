...
public class EditAdminUserController implements Initializable {
    ...
    private static EditAdminUserController instance;

    // create instance itself
    public EditAdminUserController(){this.instance = this;}
    public static EditAdminUserController getEditAdminUserController(){
        return instance;
    }
    // end instance itself
